 ...
 * @author ACER
 */
@WebServlet(name = "lichSuDonHangUs", urlPatterns = {"/lichSuDonHangUs"})
public class lichSuDonHangUs extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet lichSuDonHangUs</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet lichSuDonHangUs at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (status == null || status.trim().isEmpty()) {
            status = "Tất cả"; // Mặc định là xem tất cả
        }
        ...
        int totalRecords = dhdao.countDonHangByNguoiDung(nd.getMaND(), status);

        listDonHang = dhdao.getDonHangByNguoiDung(nd.getMaND(), status, offset, limit);
