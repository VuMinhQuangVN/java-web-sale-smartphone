 ...
 * @author ACER
 */
@WebServlet(name = "searchHangUs", urlPatterns = {"/searchHangUs"})
public class searchHangUs extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet searchHangUs</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet searchHangUs at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (keyword != null && !keyword.trim().isEmpty()) {
            list = dao.searchHang(keyword, offset, limit);
            totalRecords = dao.countSearchHang(keyword);
        } else {
