<%-- 
    Document   : infomation
    Created on : Oct 14, 2025, 4:13:24 PM
    Author     : ACER
--%>
        ...
        <main>
            <div class="account-layout">
                ...
                <div class="sidebar">
                    ...
                    <a href="<%=request.getContextPath()%>/infomationUs" class="active"><i class="fas fa-id-card me-2"></i> Thông tin cá nhân</a>
                ...
                <div class="content tab-content">
                    ...
                    <div class="tab-pane fade show active" id="info">
                        ...
                        <form method="post" action="<%=request.getContextPath()%>/updateInfoUs">
                            <div class="row mb-3">
                                <div class="col-md-6">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="diachi" class="form-control" value="<%=nd.getDiachi()%>" required>
                                </div>
                            </div>
                            <div class="text-end">
                                <button type="submit" class="btn btn-custom px-4">Cập nhật</button>
                            </div>
                        </form>
                    </div>
